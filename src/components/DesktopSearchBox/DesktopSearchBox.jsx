...
function DesktopSearchBox({ isVisible }) {
  ...
  return (
    <div
      className={`text-secondary-50 absolute z-[-1] -mt-4 max-h-[450px] w-full rounded-md bg-gradient-to-b from-slate-800 to-slate-700 px-4 py-8 transitionduration-100 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}
    >
...
FilterButton.propTypes = { text: PropTypes.string.isRequired, isActive: PropTypes.bool };
