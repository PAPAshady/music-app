...
export default function PlaylistCardSkeleton({ classNames }) {
  return (
    <div
      className={`group relative flex h-36 min-w-36 items-center justify-center overflow-hidden rounded-lg bg-gray-600/60 shadow-[2px_2px_15px_rgba(0,0,0,0.5)] lg:h-48 lg:min-w-[152px] xl:min-w-[140px] ${classNames}`}
    >
      <ShimmerOverlay />
