...
export default function NotificationMenu({ isVisible, classNames }) {
  ...
  return (
    <div
      className={`bg-primary-800/60 absolute right-[60%] z-10 w-[350px] rounded-2xl border p-4 backdrop-blur-sm transition-all duration-300 ${isVisible ? 'visible top-[130%] opacity-100' : 'invisible top-[200%] opacity-0'} ${classNames}`}
    >
