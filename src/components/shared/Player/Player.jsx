...
export default function Player() {
  return (
    <div className="border-secondary-300 bg-secondary-700/64 xs:items-start xs:pt-4 xs:pb-3 group fixed bottom-0 left-0 z-10 flex w-full items-center gap-3 rounded-t-lg border-t px-3 pt-3 pb-2 backdrop-blur-sm min-[400px]:items-center min-[480px]:p-4 sm:items-center sm:gap-4 lg:sticky lg:bottom-2 lg:justify-between lg:gap-8 lg:rounded-lg lg:border">
