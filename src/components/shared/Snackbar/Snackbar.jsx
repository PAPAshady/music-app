...
export default function Snackbar({ message, type }) {
  ...
  return (
    <div
      className={`text-primary-50 border-primary-300 z-50 mx-auto w-full rounded-sm border bg-[#4E6C96]/53 px-3 py-1.5 backdrop-blur-md transition-all ease-in-out sm:ms-4 lg:ms-6`}
    >
